/***************************************************************************************************************************************************
	...
	This plugin requires sceneprocessor to work.
	...
	Plugin precaches about 186 wav files.
...
public Plugin myinfo =
{
	...
	author = "Gravity",
	description = "Restores all laugh/taunt files (some left unused) for survivors to vocalize, 'spam'.",
	version = "1.0.0",
	url = ""
};
...
public void OnPluginStart()
{
	...
	g_hMeleeGruntChance 	= CreateConVar("restorevocals_meleegrunt_chance", "25", "Chance out of 100 that survivors vocalize melee grunts.", 0, true, 1.0, true, 100.0);
	g_hVocalChance 		= CreateConVar("restorevocals_vocalize_chance", "40", "Chance out of 100 that a survivor vocalizes unused lines.", 0, true, 1.0, true, 100.0);
}
